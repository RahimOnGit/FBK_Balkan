...
public class CoachService {
    ...
    public CoachCreateUpdateDTO getCoachForEdit(Long id) {
        User c = coachRepository.findById(id)
    ...
    public User createCoach(CoachCreateUpdateDTO dto) {
        ...
        User coach = coachMapper.toEntity(dto);
        coach.setPassword(passwordEncoder.encode(dto.getPassword()));
        return coachRepository.save(coach);
    }

    public User updateCoach(Long id, CoachCreateUpdateDTO dto) {
        ...
        User coach = coachRepository.findById(id)
                .orElseThrow(() -> new EntityNotFoundException("Coach not found"));
        ...
        User saved = coachRepository.save(coach);
